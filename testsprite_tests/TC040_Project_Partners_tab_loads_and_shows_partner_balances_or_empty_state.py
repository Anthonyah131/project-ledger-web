...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields and submit the login form to proceed to the dashboard.
        ...
        # -> Click the Partners navigation item in the sidebar to open the Partners page and then verify whether a balances section or an empty-state message is present.
        frame = context.pages[-1]
        # Click element
