...
async def run_test():
    ...
    try:
        ...
        # -> Wait briefly for the page to finish rendering (ensure spinner cleared), submit the login form with no input, then capture any visible required-field validation messages.
