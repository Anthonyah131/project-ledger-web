...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields and submit the login form, then wait for the dashboard to load.
        ...
        # -> Click the Projects navigation item to open the Projects page.
        frame = context.pages[-1]
        # Click element
