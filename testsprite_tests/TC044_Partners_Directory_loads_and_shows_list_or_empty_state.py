...
async def run_test():
    ...
    try:
        ...
        # -> Submit the login form by clicking the 'Log in' button (index 13), then after successful login navigate to the Partners page and verify its primary content loads.
        frame = context.pages[-1]
        # Click element
