...
async def run_test():
    ...
    try:
        ...
        # -> Wait briefly to ensure page ready, fill email and password with invalid credentials, submit the form, wait for potential toast, then extract notifications text to verify an error toast is visible.
        ...
        # -> Click the 'Log in' submit button to attempt login, wait for any notification/toast, then extract visible notification text to verify an error toast is shown.
        frame = context.pages[-1]
        # Click element
